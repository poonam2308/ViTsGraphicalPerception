...
class Figure1:
    ...
    def volume(flags=[False, False], preset=None):
        ...
        rr, cc = skimage.draw.line(front_bottom_left[0], front_bottom_left[1], front_bottom_right[0],
        ...
        rr, cc = skimage.draw.line(front_bottom_right[0], front_bottom_right[1], back_bottom_right[0],
                                   back_bottom_right[1])
        img[rr, cc] = 1
